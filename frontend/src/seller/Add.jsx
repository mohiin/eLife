...
export default function Add() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await axios.post(`${backendUrl}/products`, { ...data, owner: user._id },
                {
                    headers: {
        ...
        <div className="max-w-screen-xl p-4 flex-1">
            <form onSubmit={handleSubmit} className="w-full mx-auto p-4 flex flex-col gap-4">
                ...
                <div className="space-y-2 max-w-[700px]">
                    ...
                    <label htmlFor="image">
                        <img className="w-[120px]" src={data.image ? URL.createObjectURL(data.image) : assets.upload_icon} alt="" />
                ...
                <button className="btn btn-primary mt-4 w-full md:w-28 py-2 px-4">
                    {loadingProducts ? <span className="loading loading-spinner"></span> : "Add"}
                </button>
            </form>
        </div>
    )
